...
// .wrangler/tmp/pages-fVW6jU/functionsWorker-0.6595438631430395.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var DEFAULT_AUTH_API_ORIGIN = "https://api.streamsuites.app";
var PROXY_TIMEOUT_MS = 15e3;
...
__name(resolveUpstreamOrigin, "resolveUpstreamOrigin");
__name2(resolveUpstreamOrigin, "resolveUpstreamOrigin");
...
__name2(isPathAllowed, "isPathAllowed");
...
__name(appendSetCookieHeaders, "appendSetCookieHeaders");
__name2(appendSetCookieHeaders, "appendSetCookieHeaders");
...
__name(cloneResponseHeaders, "cloneResponseHeaders");
__name2(cloneResponseHeaders, "cloneResponseHeaders");
...
__name(buildErrorHtml, "buildErrorHtml");
__name2(buildErrorHtml, "buildErrorHtml");
...
__name(buildProxyErrorResponse, "buildProxyErrorResponse");
__name2(buildProxyErrorResponse, "buildProxyErrorResponse");
async function proxyAuthApiRequest(context, allowedMatchers) {
  ...
  headers.set("x-streamsuites-creator-proxy", "cloudflare-pages");
  const init = {
  ...
  try {
    ...
    return buildProxyErrorResponse(
      request,
      isTimeout ? 504 : 502,
      isTimeout ? "The StreamSuites Auth API timed out. Please try again." : "The StreamSuites Auth API is temporarily unavailable. Please try again."
    );
  }
...
__name(proxyAuthApiRequest, "proxyAuthApiRequest");
__name2(proxyAuthApiRequest, "proxyAuthApiRequest");
var ALLOWED_AUTH_PATHS = [
  "/auth/access-state",
  "/auth/debug/unlock",
...
var ALLOWED_OAUTH_PATHS = ["/oauth/twitch/start"];
async function onRequest2(context) {
  return proxyAuthApiRequest(context, ALLOWED_OAUTH_PATHS);
}
__name(onRequest2, "onRequest2");
__name2(onRequest2, "onRequest");
var SPA_SHELL_PATH = "/index.html";
var EXACT_CREATOR_ROUTES = /* @__PURE__ */ new Set([
  "/",
  "/home",
  "/overview",
  "/statistics",
...
var PREFIX_CREATOR_ROUTES = ["/integrations/", "/modules/", "/platforms/"];
...
__name(isCreatorSpaRoute, "isCreatorSpaRoute");
__name2(isCreatorSpaRoute, "isCreatorSpaRoute");
...
// .wrangler/tmp/bundle-enWTqW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-enWTqW/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6595438631430395.js.map
