...
- Creator account settings currently surface canonical slug editing and visibility, StreamSuites public profile visibility, FindMeHere listing controls, truthful dual share previews, hardened media URL previews, reserved media fields including background image URL, distinct hero Bio and Markdown About fields, an independent optional embed/upload video, Runtime-backed StreamSuites feature-gradient presets, grounded public social links, and a small pointer over to Preferences for moderator/community controls.
